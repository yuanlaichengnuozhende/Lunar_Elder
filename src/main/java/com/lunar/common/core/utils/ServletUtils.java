...
public class ServletUtils {
    ...
    public static String urlDecode(String str) {
        try {
            return URLDecoder.decode(str, Consts.UTF8);
        } catch (UnsupportedEncodingException e) {
            return "";
        }
    }
    ...
    public static Mono<Void> webFluxResponseWriter(ServerHttpResponse response, Object value) {
        return webFluxResponseWriter(response, HttpStatus.OK, value, ApiResult.FAIL);
    }
    ...
    public static Mono<Void> webFluxResponseWriter(ServerHttpResponse response, String contentType, HttpStatus status,
        ...
        String jsonStr = JsonHelper.toJson(result);
