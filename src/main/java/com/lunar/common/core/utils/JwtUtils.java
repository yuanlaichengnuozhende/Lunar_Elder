...
public class JwtUtils {
    ...
    public static String getUserId(String token) {
        Claims claims = parseToken(token);
        return getValue(claims, SecurityConsts.USER_ID);
    }
    ...
    public static String getUsername(String token) {
        Claims claims = parseToken(token);
        return getValue(claims, SecurityConsts.USERNAME);
    }
    ...
    public static String getCompanyId(String token) {
        Claims claims = parseToken(token);
        return getValue(claims, SecurityConsts.COMPANY_ID);
    }
     ...
     * @return 用户名
     */
    public static String getCompanyId(Claims claims) {
        return getValue(claims, SecurityConsts.COMPANY_ID);
    }
    ...
    public static String getOrgId(Claims claims) {
        return getValue(claims, SecurityConsts.ORG_ID);
    }
