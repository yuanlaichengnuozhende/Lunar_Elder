...
public class ComputationMaker {
    ...
    private static final String MYSQL_SCHEMA = "dct_computation";
    ...
    public static void main(String[] args) {
        // 基础包名
        String basePackage = "com.carbonstop.computation";
        // 业务模块名
        String module = "dct-module-computation";
        // entity是否放在biz包
        boolean oneDir = true;

        // 要逆向的表
        List<String> tableList = new ArrayList<>();
        tableList.add("computation_data_source");
